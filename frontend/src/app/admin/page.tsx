        ...
        <div className="container mx-auto flex flex-wrap justify-center gap-20">
          ...
          >
            <div className="w-72 text-center">
              ...
              <h1 className="text-gray-600 text-lg font-semibold">Launch Scraping</h1>
              <p className="text-gray-400 text-sm mt-2">Start the web scraping process</p>
            </div>
          </div>
